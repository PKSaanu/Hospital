...
@section('content1')
    ...
    <form class="row g-3" action="{{route ('PohStore')}}" method="post">
        @csrf
      <div class="col-md-6">
        <label class="form-label">Pregnancy</label>
        <input type="text" name="pregnancy" class="form-control" value="G" >
      </div>
      <div class="col-md-6">
        <label class="form-label">Antenatal Complications</label>
        <input type="text" name="antenatal_complications" class="form-control">
      </div>
      <div class="col-6">
      ...
      <div class="col-6">
        ...
        <input type="text" name="mode_of_delivery" class="form-control">
      </div>
      <div class="col-md-6">
      ...
      <div class="col-md-6">
        ...
        <br>
        <input  type="number" name="birth_weight" placeholder="g" style="width:100px" min="1"> 
      </div>
      <div class="col-md-6">
        <label class="form-label">Postnatal complication (Specify)</label>
        <input type="text" name="postnatal_complication" class="form-control" >
      </div>
      <div class="col-md-6">
